export function Buttom() {
    return (
    <button className='color-gradient w-[163px] h-11 rounded-full text-white font-bold shadow '>
        Request Invite
    </button>
    );
}
...
export function Menu({ handleClick }: { handleClick: () => void }) {
    return (
        <button className='w-7 h-7 text-black' type='button' onClick={handleClick}>
